...
\begin{probleme}
	...
	Au finale le train sera parvenu à la vitesse $2v$ en dépensant une énergie $2mv^2/2$.
\end{probleme}

La première clef pour comprendre le paradoxe est qu'il n'est pas correct de raisonner en se disant que ce sont les vitesses quoi «coûtent» de l'énergie. Ce sont les accélérations (et plus précisément les forces) qui demandent de l'énergie.
