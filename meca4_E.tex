...
\begin{enumerate}
	...
	\item
		Une voiture électrique produit sans doute un peu moins de $CO_2$ qu'une voiture au pétrole, mais également un peu plus de déchets radioactifs. Est-ce que c'est mieux ? Est-ce que c'est moins bien ? C'est une autre histoire.

	\item
		Écrire sur une voiture électrique une phrase du type de «zero emission», c'est au mieux de l'ignorance, mais à partir d'un certain point, c'est du mensonge.

	\item
		Méfiez vous des discours qui présentent la voiture électrique comme \emph{la} solution. Il faut produire l'électricité, c'est comme ça. La pile à hydrogène n'y change strictement rien. 

		Désolé mon enfant, mais tu utiliseras certainement dans ta vie considérablement moins de voiture que tes parents. Ne perds pas trop de temps à passer ton permis de conduire; ça a sans doute moins d'avenir que tu le crois.
