...
\begin{proof}
	Toute la partie comme quoi les transformations doivent êtres linéaires reste parce que cette partie ne demandait pas l'invariance de la vitesse de la lumière. Cependant il est possible de montrer que la transformation est linéaire rien qu'avec l'hypothèse que l'intervalle doit être conservé. Cela est fait dans \url{http://student.ulb.ac.be/~lclaesse/mes_notes.pdf}
